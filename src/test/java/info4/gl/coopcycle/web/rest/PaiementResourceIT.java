...
class PaiementResourceIT {
    ...
    private static final String DEFAULT_MOYEN = "AAAAAAAAAA";
    private static final String UPDATED_MOYEN = "BBBBBBBBBB";
    ...
    public static Paiement createEntity(EntityManager em) {
        Paiement paiement = new Paiement().montant(DEFAULT_MONTANT).moyen(DEFAULT_MOYEN);
        return paiement;
    }
    ...
    public static Paiement createUpdatedEntity(EntityManager em) {
        Paiement paiement = new Paiement().montant(UPDATED_MONTANT).moyen(UPDATED_MOYEN);
        return paiement;
    }
    ...
    void createPaiement() throws Exception {
        ...
        assertThat(testPaiement.getMoyen()).isEqualTo(DEFAULT_MOYEN);
    }
    ...
    @Test
    @Transactional
    void checkMoyenIsRequired() throws Exception {
        int databaseSizeBeforeTest = paiementRepository.findAll().size();
        // set the field null
        paiement.setMoyen(null);
    ...
    void getAllPaiements() throws Exception {
        ...
        restPaiementMockMvc
            ...
            .andExpect(jsonPath("$.[*].moyen").value(hasItem(DEFAULT_MOYEN)));
    }
    ...
    void getPaiement() throws Exception {
        ...
        restPaiementMockMvc
            ...
            .andExpect(jsonPath("$.moyen").value(DEFAULT_MOYEN));
    }
    ...
    void putNewPaiement() throws Exception {
        ...
        updatedPaiement.montant(UPDATED_MONTANT).moyen(UPDATED_MOYEN);
        ...
        assertThat(testPaiement.getMoyen()).isEqualTo(UPDATED_MOYEN);
    }
    ...
    void partialUpdatePaiementWithPatch() throws Exception {
        ...
        partialUpdatedPaiement.moyen(UPDATED_MOYEN);
    ...
    void fullUpdatePaiementWithPatch() throws Exception {
        ...
        partialUpdatedPaiement.montant(UPDATED_MONTANT).moyen(UPDATED_MOYEN);
