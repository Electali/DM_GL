...
class CourseResourceIT {
    ...
    public static Course createEntity(EntityManager em) {
        Course course = new Course().adresse(DEFAULT_ADRESSE);
        return course;
    }
    ...
    public static Course createUpdatedEntity(EntityManager em) {
        Course course = new Course().adresse(UPDATED_ADRESSE);
        return course;
    }
    ...
    void createCourse() throws Exception {
        ...
        assertThat(testCourse.getAdresse()).isEqualTo(DEFAULT_ADRESSE);
    }
    ...
    void putNewCourse() throws Exception {
        ...
        updatedCourse.adresse(UPDATED_ADRESSE);
        ...
        Course testCourse = courseList.get(courseList.size() - 1);
        assertThat(testCourse.getAdresse()).isEqualTo(UPDATED_ADRESSE);
    }
    ...
    void fullUpdateCourseWithPatch() throws Exception {
        ...
        partialUpdatedCourse.adresse(UPDATED_ADRESSE);
