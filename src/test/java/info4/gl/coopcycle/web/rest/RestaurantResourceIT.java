...
class RestaurantResourceIT {
    ...
    public static Restaurant createEntity(EntityManager em) {
        Restaurant restaurant = new Restaurant().nom(DEFAULT_NOM).adresse(DEFAULT_ADRESSE);
        return restaurant;
    }
    ...
    public static Restaurant createUpdatedEntity(EntityManager em) {
        Restaurant restaurant = new Restaurant().nom(UPDATED_NOM).adresse(UPDATED_ADRESSE);
        return restaurant;
    }
    ...
    void putNewRestaurant() throws Exception {
        ...
        updatedRestaurant.nom(UPDATED_NOM).adresse(UPDATED_ADRESSE);
    ...
    void fullUpdateRestaurantWithPatch() throws Exception {
        ...
        partialUpdatedRestaurant.nom(UPDATED_NOM).adresse(UPDATED_ADRESSE);
