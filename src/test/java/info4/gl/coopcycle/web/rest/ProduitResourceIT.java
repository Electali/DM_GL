...
import info4.gl.coopcycle.repository.ProduitRepository;
import info4.gl.coopcycle.service.dto.ProduitDTO;
import info4.gl.coopcycle.service.mapper.ProduitMapper;
...
class ProduitResourceIT {
    ...
    public static Produit createEntity(EntityManager em) {
        Produit produit = new Produit().nom(DEFAULT_NOM).description(DEFAULT_DESCRIPTION);
        return produit;
    }
    ...
    public static Produit createUpdatedEntity(EntityManager em) {
        Produit produit = new Produit().nom(UPDATED_NOM).description(UPDATED_DESCRIPTION);
        return produit;
    }
    ...
    void putNewProduit() throws Exception {
        ...
        updatedProduit.nom(UPDATED_NOM).description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateProduitWithPatch() throws Exception {
        ...
        partialUpdatedProduit.nom(UPDATED_NOM).description(UPDATED_DESCRIPTION);
