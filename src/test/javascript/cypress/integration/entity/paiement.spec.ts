...
describe('Paiement e2e test', () => {
  ...
  const paiementSample = { montant: 83707, moyen: 'parsing whiteboard' };
  ...
  describe('Paiement page', () => {
    ...
    describe('with existing value', () => {
      ...
      it('edit button click should load edit Paiement page', () => {
  ...
  describe('new Paiement page', () => {
    ...
    it('should create an instance of Paiement', () => {
      cy.get(`[data-cy="montant"]`).type('25684').should('have.value', '25684');

      cy.get(`[data-cy="moyen"]`).type('Centre Exclusive Alsace').should('have.value', 'Centre Exclusive Alsace');
