...
describe('Restaurant e2e test', () => {
  ...
  const restaurantSample = { adresse: 'Gorgeous Unbranded a' };
  ...
  describe('new Restaurant page', () => {
    ...
    it('should create an instance of Restaurant', () => {
      ...
      cy.get(`[data-cy="adresse"]`).type('Berkshire synthesizing Tasty').should('have.value', 'Berkshire synthesizing Tasty');
