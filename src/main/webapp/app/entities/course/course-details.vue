    ...
    <div class="col-8">
      <div v-if="course">
        <h2 class="jh-entity-heading" data-cy="courseDetailsHeading">
          <span v-text="$t('coopcycleApp.course.detail.title')">Course</span> {{ course.id }}
        </h2>
        <dl class="row jh-entity-details">
          <dt>
            <span v-text="$t('coopcycleApp.course.adresse')">Adresse</span>
          </dt>
          <dd>
            <span>{{ course.adresse }}</span>
          </dd>
          <dt>
            <span v-text="$t('coopcycleApp.course.panier')">Panier</span>
          </dt>
          <dd>
          ...
          <dt>
            <span v-text="$t('coopcycleApp.course.paiement')">Paiement</span>
          </dt>
          <dd>
            <div v-if="course.paiement">
              <router-link :to="{ name: 'PaiementView', params: { paiementId: course.paiement.id } }">{{ course.paiement.id }}</router-link>
            </div>
          </dd>
          <dt>
            <span v-text="$t('coopcycleApp.course.utilisateur')">Utilisateur</span>
          </dt>
          <dd>
